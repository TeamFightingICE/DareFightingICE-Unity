...
public class SimFrameDataManager : Singleton<SimFrameDataManager>
{
    public GameObject[] character = new GameObject[2];
    private Rigidbody2D[] rb = new Rigidbody2D[2];
    private SimCharacterController[] _controllers = new SimCharacterController[2];
    ...
    public void SetupFrameData(GameObject character1, GameObject character2, int frameInfo)
    {
        ...
        _controllers[0] = character1.GetComponent<SimCharacterController>();
        _controllers[1] = character2.GetComponent<SimCharacterController>();
        currentFrameNumber = frameInfo;
    ...
    public void ProcessFrameData(int framenum)
    {
        UpdateCharacterData();
